...
public class EmergencyInActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        String message="(자동 발송)\n1] 화학물질과 관련하여 긴급한 상황이 발생하였습니다.";
        sendSMS("999",message);
        message="2] 주소: 부산 강서구 녹산산단382로14번가길 1201-35, 공학1관 404호";
        sendSMS("999",message);
        message="3] 일시: "+sdf.format(date);
        sendSMS("999",message);
        message="4] 본 메시지는 자동발송 되었고, 세부 상황에 대해 이 번호로 전화 부탁드립니다.";
        sendSMS("999",message);
    }
}